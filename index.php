...
<html>
<head>
<title>Launch Page: DCC Lankhmar Thief Character Generator</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="DCC Lankhmar Thief Character Generator" class="image" /></h1>
    ...
    <div class="content9">
        ...
        <br/>
            ...
            <span class="formIputDescriptionLankhmar">Thieving Path:</span>	
			  <select id="thievingPath" name="theThievingPath" class="alignmentBox">			
                <option value="0" selected>Path of the Swindler</option>
				<option value="1">Path of the Assassin</option>
				<option value="2">Path of the Boss</option>
			  </select>
            ...
            <br/>
                  ...
                  <div class="formIputDescriptionLankhmar">
                  <span class="footnote3"><input type="checkbox" id="alignmentCheckBox" value="1" name="theAlignmentCheckBox">Use Alignment (Thieves' Path)</span>
                  </div>
            ...
            <option value="2">Order of AGI, LUCK, STA, STR, PER, INT</option>
            <option value="3">Order of AGI, PER, LUCK, INT, STR, STA</option>
            <option value="4">Order of LUCK, AGI, PER, STA, STR, INT</option>
            <option value="5">Order of LUCK, AGI, STR, INT, PER, STA</option>
            </select>
